...
{
    internal class DashboardConverter : JsonConverter
    {
        ...
        /// </summary>
        /// <param name="engine">
        /// A valid instance to the underlying Engine that the model controls.
        /// </param>
        /// <exception cref="ArgumentException">
        /// In the event that the engine parameter is null, will throw ArgumentException.
        /// </exception>
        public DashboardConverter(Engine engine)
        {
            m_engine = engine;
        ...
        {
            return objectType == typeof(DashboardModel);
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var model = new DashboardModel(m_engine);

            model.TotalDataBlocked = ByteSize.FromBytes(jo["TotalDataBlocked"]["Bytes"].ToObject<double>());
            model.TotalHtmlElementsRemoved = jo["TotalHtmlElementsRemoved"].ToObject<uint>();
            model.TotalRequestsBlocked = jo["TotalRequestsBlocked"].ToObject<uint>();
